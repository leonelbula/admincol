...
-- Tiempo de generación: 01-02-2020 a las 12:23:42
...
INSERT INTO `comentario` (`id`, `usuario`, `detalles`, `estado`) VALUES
(1, 'USUARIO 1', 'COMENTARIO', 1);
...
--
-- Estructura de tabla para la tabla `datosconsignacion`
--

DROP TABLE IF EXISTS `datosconsignacion`;
CREATE TABLE IF NOT EXISTS `datosconsignacion` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nombre` text COLLATE utf8_spanish_ci NOT NULL,
...
--
-- Volcado de datos para la tabla `datosconsignacion`
--

INSERT INTO `datosconsignacion` (`id`, `nombre`, `numero`) VALUES
(1, 'nombre del titular', 1545044441);
...
INSERT INTO `datos_empresa` (`id`, `nombre`, `nit`, `direccion`, `ciudad`, `departamento`, `telefono`, `logo`) VALUES
(1, 'COLCAMBIOS', '5555555', 'CALLE 11 ', 'CIUDAD', 'DEPARTAMENTO', '777777', 'logocolcambios.png');
...
(2, 1, 1, '2020-01-06', 100000, 0, '548f773d_z.jpg', '2.jpg'),
(3, 1, 2, '2020-01-07', 20000, 1, 'NULL', 'NULL'),
(4, 1, 2, '2020-01-07', 200000, 1, 'IMG-20181120-WA0000.jpg', 'NULL'),
(5, 1, 2, '2020-01-27', 10100, 3, 'NULL', 'NULL'),
(6, 1, 1, '2020-01-30', 150000, 4, 'NULL', 'NULL');
...
INSERT INTO `notificaciones` (`id`, `consignacion`, `usuario`, `comentario`, `confirmacion`) VALUES
(1, 7, 6, 2, 4);
...
(1, 1, 2, '2020-01-08', 'prueba1', 'respuesta', 0, 'NULL'),
